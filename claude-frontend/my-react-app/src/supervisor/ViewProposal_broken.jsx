...
const ViewProposal = () => {
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-12">      <div className="max-w-2xl w-full mx-auto p-5 bg-white rounded-lg shadow-lg">
        ...
        {proposal ? (
          <div className="bg-gray-50 p-4 rounded mt-3">
            ...
            <p className="mb-3">
              <strong>Submitted On:</strong> {new Date(proposal.createdAt).toLocaleDateString()}
            </p>
            <p className="mb-3">
          ...
          <div className="text-center py-8 text-gray-500">
            ...
            <p className="text-sm">The requested proposal could not be loaded.</p>
          </div>
        )}
