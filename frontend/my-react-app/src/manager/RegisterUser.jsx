...
const RegisterUser = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    email: "",
    password: "",
    roles: "", // Changed from array to single string
  });
  ...
  const handleRoleChange = (e) => {
    ...
    setFormData((prev) => ({
      ...prev,
      roles: value, // Set single role instead of array
    }));
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await ManagerAPI.registerUser(managerId, {
        ...formData,
        roles: [formData.roles], // Convert single role to array for API
      });
                ...
                {roles.map((role) => (
                  ...
                  >
                    <input
                      ...
                      checked={formData.roles === role.role_name}
