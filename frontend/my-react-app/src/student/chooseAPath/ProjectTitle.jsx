...
const ProjectTitle = () => {
  ...
  const getProjectDifficulty = () => {
    ...
    if (
      projectData.specialization?.toLowerCase().includes("machine learning") ||
  ...
  const getPrerequisites = () => {
    ...
    if (
      specialization.includes("machine learning") ||
      title.includes("ml") ||
      title.includes("ai")
    ) {
      ...
      specialization.includes("security") ||
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="bg-green-50 p-6 rounded-lg border border-green-100">
                  ...
                  <p className="text-green-700">
                    {projectData.type || "Individual Project"}
                  </p>
                </div>
                ...
                {projectData.outcome && (
                  <div className="bg-indigo-50 p-6 rounded-lg border border-indigo-100">
                    ...
                    <p className="text-indigo-700">{projectData.outcome}</p>
                  </div>
                )}
            ...
            <div className="mb-8">
              ...
              <div className="bg-yellow-50 p-6 rounded-lg border border-yellow-100">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <span className="font-semibold text-yellow-800 block mb-2">
