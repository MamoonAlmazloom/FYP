      ...
      if (response.success) {
        ...
        const decisionMessages = {
          approve: {
            ...
            message:
              "The proposal has been approved and a project has been created. All relevant parties will be notified.",
            icon: "✅",
          ...
          reject: {
            ...
            message:
              "The proposal has been rejected and the submitter has been notified with your feedback.",
            icon: "❌",
            color: "text-red-600",
            bgColor: "bg-red-50",
          ...
          modify: {
            ...
            message:
              "The submitter will receive your feedback and can modify their proposal accordingly.",
            icon: "🔄",
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <ul className="text-sm text-green-700 space-y-1">
                        ...
                        <li>• Student and supervisor have been notified</li>
                        <li>• Project work can now begin</li>
                      </ul>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <ul className="text-sm text-yellow-700 space-y-1">
                        <li>• Submitter will receive your feedback</li>
                        <li>• They can modify and resubmit the proposal</li>
                        <li>• Updated proposal will require review again</li>
                      </ul>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <ul className="text-sm text-red-700 space-y-1">
                        <li>• Submitter has been notified of rejection</li>
                        <li>• Your feedback has been shared</li>
