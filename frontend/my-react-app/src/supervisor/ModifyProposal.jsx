...
const ModifyProposal = () => {
  ...
  useEffect(() => {
    const loadProposal = async () => {
      try {
        ...
        if (!proposalId) {
          navigate("/supervisor/view-proposal");
          return;
        }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 flex items-center justify-center p-8">
      <div className="max-w-2xl w-full mx-auto p-8 bg-white/80 backdrop-blur-md rounded-2xl shadow-2xl border border-white/20">
